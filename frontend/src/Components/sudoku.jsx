...
const SudokuTable = () => {
  ...
  const handleInputChange = (rowIndex, colIndex, value) => {
    if (value === "" || isValidInput(rowIndex, colIndex, value)) {
      ...
      alert(
        "Invalid move! Number already exists in the row, column, or subgrid."
      );
    }
  };
                  ...
                  {row.map((cell, colIndex) => (
                    <td key={colIndex} className="sudoku-cell">
                      <input
                        ...
                        style={{
                          color: userInput[rowIndex][colIndex]
                            ? "#FFD700"
                            : "white",
                          fontWeight: "bold",
                        }}
        ...
        >
          <div className="modal-dialog " role="document">
            <div
              ...
              style={{ backgroundColor: "#2c0b0e", color: "#ea868f" }}
            >
              ...
              <div className="modal-body">
                <p>
                  The given Sudoku puzzle cannot be solved. Please check your
                  input or reset the grid.
                </p>
              </div>
            ...
            >
              <div className="modal-header">
                <h5 className="modal-title">
                  Cannot get sudoku from uploaded image
                </h5>
                <button
                  type="button"
                  className="btn-close"
              ...
              <div className="modal-body">
                <p>From the uploaded image sudoku cannot be extracted</p>
              </div>
              <div className="modal-footer">
                <button
                  type="button"
        ...
        >
          <div className="modal-dialog " role="document">
            ...
            >
              ...
              <div className="modal-body">
                <p>
                  Please recheck all the cells of sudoku because some digits can
                  be predicted wrong by the model
                </p>
              </div>
              {/* <div className="modal-footer">
            <button
